...
{
    public class ScrimMatchReportInfantryPlayerRoundStatsConfiguration : IEntityTypeConfiguration<ScrimMatchReportInfantryPlayerRoundStats>
    {
        public void Configure(EntityTypeBuilder<ScrimMatchReportInfantryPlayerRoundStats> builder)
        {
            builder.ToView("View_ScrimMatchReportInfantryPlayerRoundStats");

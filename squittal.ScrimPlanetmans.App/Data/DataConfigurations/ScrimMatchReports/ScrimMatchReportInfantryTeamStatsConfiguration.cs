...
{
    public class ScrimMatchReportInfantryTeamStatsConfiguration : IEntityTypeConfiguration<ScrimMatchReportInfantryTeamStats>
    {
        public void Configure(EntityTypeBuilder<ScrimMatchReportInfantryTeamStats> builder)
        {
            builder.ToView("View_ScrimMatchReportInfantryTeamStats");

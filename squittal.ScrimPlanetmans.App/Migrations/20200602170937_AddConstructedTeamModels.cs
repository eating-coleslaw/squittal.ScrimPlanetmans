...
namespace squittal.ScrimPlanetmans.App.Migrations
{
    public partial class AddConstructedTeamModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ConstructedTeamFactionPreference",
                columns: table => new
                {
                    ConstructedTeamId = table.Column<int>(nullable: false),
                    PreferenceOrdinalValue = table.Column<int>(nullable: false),
                    FactionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConstructedTeamFactionPreference", x => new { x.ConstructedTeamId, x.PreferenceOrdinalValue });
                    table.ForeignKey(
                        name: "FK_ConstructedTeamFactionPreference_ConstructedTeam_ConstructedTeamId",
